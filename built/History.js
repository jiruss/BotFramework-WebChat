...
var WrappedActivity = (function (_super) {
    ...
    WrappedActivity.prototype.render = function () {
            ...
            case 'retry':
                timeLine =
                    React.createElement("span", null,
                        ...
                        ' ',
                        React.createElement("a", { href: ".", onClick: refreshPage }, this.props.format.strings.messageRetry));
                break;
            default:
                var sent = void 0;
        ...
        return (React.createElement(this.props.onClickActivity ? 'button' : 'div', {
            ...
            React.createElement("div", { className: contentClassName },
                ...
                this.props.children)), React.createElement("div", { className: 'wc-message-from wc-message-from-' + who }, timeLine)));
    };
